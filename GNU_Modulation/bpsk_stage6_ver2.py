...
class bpsk_stage6_ver2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._time_offset_win, 0, 10, 1, 10)
        for r in range(0, 1):
        ...
        for c in range(0, 10):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._delay_range = qtgui.Range(0, 500, 1, 64, 200)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_win, 2, 10, 10, 10)
        for r in range(2, 12):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(10, 20):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.connect((self.channels_channel_model_0, 0), (self.fft_filter_xxx_0, 0))
